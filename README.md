...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 6,164 | 🐛 2,810 | 🌐 HTML | 📅 2026-09-21
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 6,164 | 🐛 2,810 | 🌐 HTML | 📅 2026-09-21
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 6,164 | 🐛 2,810 | 🌐 HTML | 📅 2026-09-21
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow/part) ⭐ 6,164 | 🐛 2,810 | 🌐 HTML | 📅 2026-09-21
...
* [Nude UI](https://github.com/LeaVerou/nudeui) ⭐ 235 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-15 - Collection of accessible, customizable, ultra-light web components.
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 20,012 | 🐛 186 | 🌐 JavaScript | 📅 2026-09-12 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,250 | 🐛 117 | 🌐 TypeScript | 📅 2026-07-07 - Web component for rendering interactive 3D models.
...
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 6,041 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-20 - Web component for drawing patterns with CSS.
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,719 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-20 - Web component for chat with AI capabilities.
...
* [`<rapi-doc>`](https://github.com/mrin9/RapiDoc) ⭐ 1,899 | 🐛 139 | 🌐 JavaScript | 📅 2026-02-11 - Web component for creating documentation from OpenAPI Specification.
* [`<emoji-picker>`](https://github.com/nolanlawson/emoji-picker-element) ⭐ 1,755 | 🐛 38 | 🌐 JavaScript | 📅 2026-06-08 - Lightweight emoji picker, distributed as a web component.
...
* [`<midi-player>`](https://github.com/cifkao/html-midi-player) ⭐ 907 | 🐛 21 | 🌐 TypeScript | 📅 2025-07-06 - MIDI file player and visualizer web components.
...
* [`<progressive-image>`](https://github.com/andreruffert/progressive-image-element) ⭐ 270 | 🐛 2 | 🌐 HTML | 📅 2026-09-21 - Custom element to progressively enhance image placeholders.
...
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 198 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-13 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 185 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,619 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-14 quickly into your page using custom elements.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,901 | 🐛 1,029 | 🌐 JavaScript | 📅 2026-08-26 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
...
* [LDRS](https://github.com/GriffinJohnston/ldrs) ⭐ 2,214 | 🐛 1 | 🌐 TypeScript | 📅 2025-10-22 - Lightweight, customizable loading animations/spinners.
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,963 | 🐛 171 | 🌐 JavaScript | 📅 2026-09-21 - Set of highly performant, accessible and flexible Web Components.
...
* [Web Awesome](https://github.com/shoelace-style/webawesome) ⭐ 1,330 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-18 - Open source library of web components from Font Awesome.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 582 | 🐛 927 | 🌐 JavaScript | 📅 2026-09-21 - Evolving set of high-quality web components for building business web applications.
...
* [VSCode Elements](https://github.com/vscode-elements/elements) ⭐ 457 | 🐛 62 | 🌐 HTML | 📅 2026-09-19 - Web component library for developing Visual Studio Code extensions.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 170 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-21 - Complete library of UI components from Infragistics.
...
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 151 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-21 - Collection of user interface web components for Umbraco CMS.
...
* [PlayCanvas Web Components](https://github.com/playcanvas/web-components) ⭐ 110 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-19 - Custom elements for building 3D interactive web apps with the PlayCanvas Engine.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 79 | 🐛 46 | 🌐 JavaScript | 📅 2026-09-21 - Collection of web components for building Brightspace applications.
...
* [One Platform Components](https://github.com/1-Platform/op-components) ⭐ 33 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-19 - Set of web components for Red Hat One Platform.
...
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 29 | 🐛 47 | 🌐 HTML | 📅 2026-09-21 - A schema for mutation testing results with the web components to visualize it.
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 66 | 🌐 JavaScript | 📅 2026-09-21 - Components for building web applications with Nuxeo using Web Components.
...
* [TEI Publisher Components](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 71 | 🌐 JavaScript | 📅 2026-09-20 - Collection of web components used by TEI Publisher and apps generated by it.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-21 - Ser of web components used by Equinor Fusion.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 20,283 | 🐛 818 | 🌐 TypeScript | 📅 2026-09-21 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 11,260 | 🐛 186 | 🌐 SCSS | 📅 2026-09-20 - Material Design implemented as Web Components.
* [UI5 Web Components](https://github.com/UI5/webcomponents) ⭐ 1,780 | 🐛 219 | 🌐 TypeScript | 📅 2026-09-21 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,538 | 🐛 239 | 🌐 TypeScript | 📅 2026-09-21 - Adobe Spectrum design language implementation built with Web Components.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 375 | 🐛 101 | 🌐 TypeScript | 📅 2026-09-21 - Web Components implementing Siemens iX design system.
* [Calcite Design System](https://github.com/Esri/calcite-design-system) ⭐ 373 | 🐛 975 | 🌐 TypeScript | 📅 2026-09-21 - Web Components for Esri's Calcite design framework.
...
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/main/web-components) ⭐ 213 | 🐛 52 | 🌐 SCSS | 📅 2026-09-21 - Set of UI components based on Momentum Design.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 151 | 🐛 149 | 🌐 HTML | 📅 2026-09-21 - Web components for building uniform experiences with the Red Hat brand.
...
* [NVIDIA Elements](https://github.com/nvidia/elements) ⭐ 88 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-21 - The Design Language and UI Agent Harness for AI/ML Factories, Robotics, and Autonomous Vehicles.
...
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 70 | 🐛 87 | 🌐 TypeScript | 📅 2026-09-21 - Library of Web Components adhering to the Forge Design System.
* [Lyne Components](https://github.com/sbb-design-systems/lyne-components) ⭐ 66 | 🐛 79 | 🌐 TypeScript | 📅 2026-09-21 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Omi](https://github.com/Tencent/omi) ⭐ 13,268 | 🐛 70 | 🌐 TypeScript | 📅 2026-03-27 - Next generation web framework in 4kb JavaScript (Web Components + JSX + Proxy + Store + Path Updating).
* [Stencil](https://github.com/stenciljs/core) ⭐ 13,130 | 🐛 177 | 🌐 TypeScript | 📅 2026-09-21 - Compiler for generating Web Components.
...
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,790 | 🐛 413 | 🌐 JavaScript | 📅 2026-09-15 - blazing fast, enterprise-grade Web Components foundation.
...
* [Joist](https://github.com/joist-framework/joist) ⭐ 134 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-19 - Set of small libraries designed to add the bare minimum to web components to make you productive.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 36,062 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-21 - Library that extends Solid adding Custom Web Components and extensions.
* [hybrids](https://github.com/hybridsjs/hybrids) ⭐ 3,177 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-17 - UI library for creating Web Components with simple and functional API.
* [haunted](https://github.com/matthewp/haunted) ⭐ 2,719 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-18 - React's Hooks API implemented for web components.
...
* [pion](https://github.com/pionjs/pion) ⭐ 82 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-21 - React's Hooks API for web components with lit-html.
...
* [remount](https://github.com/rstacruz/remount) ⭐ 718 | 🐛 11 | 🌐 JavaScript | 📅 2023-03-08 - Mount React components to the DOM using custom elements.
...
* [nuxt-custom-elements](https://github.com/GrabarzUndPartner/nuxt-custom-elements) ⭐ 83 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-19 - Export your project components as custom elements for integration into external pages.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,901 | 🐛 1,029 | 🌐 JavaScript | 📅 2026-08-26 - Web component framework to easily create user-first experiences for the web.
...
* [cypress-lit](https://github.com/simonireilly/cypress-lit) ⭐ 25 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-19 - Test your Lit elements and native web components in Cypress with all the modern browsers.
...
* [Web Components Codemods](https://github.com/kcmr/web-components-codemods) ⭐ 10 | 🐛 37 | 🌐 JavaScript | 📅 2026-09-19 - Codemods for Web Components.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 6,164 | 🐛 2,810 | 🌐 HTML | 📅 2026-09-21
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,790 | 🐛 413 | 🌐 JavaScript | 📅 2026-09-15 - Shadow DOM polyfill by [LWC](https://lwc.dev).
