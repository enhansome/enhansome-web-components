...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 6,128 | 🐛 2,804 | 🌐 HTML | 📅 2026-09-02
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 6,128 | 🐛 2,804 | 🌐 HTML | 📅 2026-09-02
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 6,128 | 🐛 2,804 | 🌐 HTML | 📅 2026-09-02
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 6,128 | 🐛 2,804 | 🌐 HTML | 📅 2026-09-02
...
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,221 | 🐛 117 | 🌐 TypeScript | 📅 2026-07-07 - Web component for rendering interactive 3D models.
...
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 6,032 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-01 - Web component for drawing patterns with CSS.
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,704 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-01 - Web component for chat with AI capabilities.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,602 | 🐛 14 | 🌐 JavaScript | 📅 2026-08-26 quickly into your page using custom elements.
...
* [`<pdfjs-viewer-element>`](https://github.com/alekswebnet/pdfjs-viewer-element) ⭐ 77 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-31 - Custom element that embeds PDF.js default viewer.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 581 | 🐛 924 | 🌐 JavaScript | 📅 2026-09-02 - Evolving set of high-quality web components for building business web applications.
...
* [Apollo Elements](https://github.com/apollo-elements/apollo-elements) ⭐ 423 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-02 - Custom elements for using Apollo GraphQL with various web components libraries.
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 274 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-01 - ELMS:LN produced web components for any project.
...
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 240 | 🐛 333 | 🌐 JavaScript | 📅 2026-09-02 - Collection of Web Components made by Clever Cloud.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 169 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-02 - Complete library of UI components from Infragistics.
...
* [PlayCanvas Web Components](https://github.com/playcanvas/web-components) ⭐ 109 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-01 - Custom elements for building 3D interactive web apps with the PlayCanvas Engine.
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 106 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-02 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 79 | 🐛 45 | 🌐 JavaScript | 📅 2026-09-01 - Collection of web components for building Brightspace applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 82 | 🌐 JavaScript | 📅 2026-09-02 - Components for building web applications with Nuxeo using Web Components.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 36 | 🌐 TypeScript | 📅 2026-09-02 - Ser of web components used by Equinor Fusion.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 20,243 | 🐛 795 | 🌐 TypeScript | 📅 2026-09-02 - Library of Web Components that supports Microsoft's Fluent design language.
...
* [FAST Components](https://github.com/microsoft/fast/tree/master/packages/web-components) ⭐ 9,667 | 🐛 79 | 🌐 TypeScript | 📅 2026-09-01 - Library of Web Components based on the FAST design language.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,770 | 🐛 229 | 🌐 TypeScript | 📅 2026-09-02 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,536 | 🐛 237 | 🌐 TypeScript | 📅 2026-09-02 - Adobe Spectrum design language implementation built with Web Components.
...
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 373 | 🐛 984 | 🌐 TypeScript | 📅 2026-09-02 - Shared Web Components for Esri's Calcite design framework.
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 371 | 🐛 98 | 🌐 TypeScript | 📅 2026-09-02 - Web Components implementing Siemens iX design system.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 148 | 🐛 193 | 🌐 HTML | 📅 2026-09-01 - Web components for building uniform experiences with the Red Hat brand.
* [OutlineJS](https://github.com/phase2/outline) ⭐ 131 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-11 - Web component based design system starter kit.
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 131 | 🐛 73 | 🌐 TypeScript | 📅 2026-09-02 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [NVIDIA Elements](https://github.com/nvidia/elements) ⭐ 85 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-02 - The Design Language and UI Agent Harness for AI/ML Factories, Robotics, and Autonomous Vehicles.
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 68 | 🐛 64 | 🌐 TypeScript | 📅 2026-09-01 - Library of Web Components adhering to the Forge Design System.
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 66 | 🐛 76 | 🌐 TypeScript | 📅 2026-09-02 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,126 | 🐛 178 | 🌐 TypeScript | 📅 2026-09-01 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/master/packages/web-components/fast-element) ⭐ 9,667 | 🐛 79 | 🌐 TypeScript | 📅 2026-09-01 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,955 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-02 - Library that extends Solid adding Custom Web Components and extensions.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 6,128 | 🐛 2,804 | 🌐 HTML | 📅 2026-09-02
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 6,128 | 🐛 2,804 | 🌐 HTML | 📅 2026-09-02
