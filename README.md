...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 6,153 | 🐛 2,811 | 🌐 HTML | 📅 2026-09-15
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 6,153 | 🐛 2,811 | 🌐 HTML | 📅 2026-09-15
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 6,153 | 🐛 2,811 | 🌐 HTML | 📅 2026-09-15
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow/part) ⭐ 6,153 | 🐛 2,811 | 🌐 HTML | 📅 2026-09-15
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 20,008 | 🐛 186 | 🌐 JavaScript | 📅 2026-09-12 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,245 | 🐛 117 | 🌐 TypeScript | 📅 2026-07-07 - Web component for rendering interactive 3D models.
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,713 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-14 - Web component for chat with AI capabilities.
...
* [`<active-table>`](https://github.com/OvidijusParsiunas/active-table) ⭐ 326 | 🐛 28 | 🌐 TypeScript | 📅 2026-02-26 - Editable table web component.
* [`<api-viewer>`](https://github.com/web-padawan/api-viewer-element) ⭐ 284 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-04 - API documentation and live playground for Web Components.
* [`<progressive-image>`](https://github.com/andreruffert/progressive-image-element) ⭐ 270 | 🐛 2 | 🌐 HTML | 📅 2026-09-14 - Custom element to progressively enhance image placeholders.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 185 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,608 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-14 quickly into your page using custom elements.
...
* [`<range-slider>`](https://github.com/andreruffert/range-slider-element) ⭐ 93 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-14 - Accessible range slider custom element with keyboard support.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,902 | 🐛 1,028 | 🌐 JavaScript | 📅 2026-08-26 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,963 | 🐛 190 | 🌐 JavaScript | 📅 2026-09-14 - Set of highly performant, accessible and flexible Web Components.
...
* [Web Awesome](https://github.com/shoelace-style/webawesome) ⭐ 1,318 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-14 - Open source library of web components from Font Awesome.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 582 | 🐛 931 | 🌐 JavaScript | 📅 2026-09-15 - Evolving set of high-quality web components for building business web applications.
...
* [VSCode Elements](https://github.com/vscode-elements/elements) ⭐ 457 | 🐛 61 | 🌐 HTML | 📅 2026-09-14 - Web component library for developing Visual Studio Code extensions.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 274 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-14 - ELMS:LN produced web components for any project.
...
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 240 | 🐛 330 | 🌐 JavaScript | 📅 2026-09-15 - Collection of Web Components made by Clever Cloud.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 170 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-15 - Complete library of UI components from Infragistics.
* [Nightingale](https://github.com/ebi-webcomponents/nightingale) ⭐ 152 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-01 - Data visualisation web components for the life sciences.
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 151 | 🐛 61 | 🌐 TypeScript | 📅 2026-09-14 - Collection of user interface web components for Umbraco CMS.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 106 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-15 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 79 | 🐛 49 | 🌐 JavaScript | 📅 2026-09-15 - Collection of web components for building Brightspace applications.
...
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 29 | 🐛 45 | 🌐 HTML | 📅 2026-09-14 - A schema for mutation testing results with the web components to visualize it.
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 78 | 🌐 JavaScript | 📅 2026-09-15 - Components for building web applications with Nuxeo using Web Components.
* [Morpheus](https://github.com/romshark/morpheus) ⭐ 26 | 🐛 2 | 🌐 templ | 📅 2026-08-05 - An experimental web components UI kit.
...
* [TEI Publisher Components](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 70 | 🌐 JavaScript | 📅 2026-09-13 - Collection of web components used by TEI Publisher and apps generated by it.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-15 - Ser of web components used by Equinor Fusion.
* [Furo Webcomponents](https://github.com/eclipse/eclipsefuro-web) ⭐ 11 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-13 - Enterprise ready set of web components which work best with Eclipse Furo.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 20,271 | 🐛 809 | 🌐 TypeScript | 📅 2026-09-15 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 11,244 | 🐛 185 | 🌐 SCSS | 📅 2026-09-15 - Material Design implemented as Web Components.
* [UI5 Web Components](https://github.com/UI5/webcomponents) ⭐ 1,776 | 🐛 224 | 🌐 TypeScript | 📅 2026-09-15 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,536 | 🐛 231 | 🌐 TypeScript | 📅 2026-09-15 - Adobe Spectrum design language implementation built with Web Components.
...
* [Calcite Design System](https://github.com/Esri/calcite-design-system) ⭐ 373 | 🐛 977 | 🌐 TypeScript | 📅 2026-09-14 - Web Components for Esri's Calcite design framework.
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 373 | 🐛 112 | 🌐 TypeScript | 📅 2026-09-15 - Web Components implementing Siemens iX design system.
* [Crayons](https://github.com/freshdesk/crayons) ⭐ 248 | 🐛 48 | 🌐 JavaScript | 📅 2026-09-15 - Collection of web components that adheres to the Freshworks Design System.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 150 | 🐛 161 | 🌐 HTML | 📅 2026-09-14 - Web components for building uniform experiences with the Red Hat brand.
* [OutlineJS](https://github.com/phase2/outline) ⭐ 131 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-11 - Web component based design system starter kit.
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 131 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-15 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [NVIDIA Elements](https://github.com/nvidia/elements) ⭐ 86 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-15 - The Design Language and UI Agent Harness for AI/ML Factories, Robotics, and Autonomous Vehicles.
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 69 | 🐛 72 | 🌐 TypeScript | 📅 2026-09-14 - Library of Web Components adhering to the Forge Design System.
* [Lyne Components](https://github.com/sbb-design-systems/lyne-components) ⭐ 66 | 🐛 73 | 🌐 TypeScript | 📅 2026-09-15 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Omi](https://github.com/Tencent/omi) ⭐ 13,266 | 🐛 70 | 🌐 TypeScript | 📅 2026-03-27 - Next generation web framework in 4kb JavaScript (Web Components + JSX + Proxy + Store + Path Updating).
* [Stencil](https://github.com/stenciljs/core) ⭐ 13,127 | 🐛 177 | 🌐 TypeScript | 📅 2026-09-14 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/main/packages/fast-element) ⭐ 9,673 | 🐛 75 | 🌐 TypeScript | 📅 2026-09-14 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,788 | 🐛 415 | 🌐 JavaScript | 📅 2026-09-14 - blazing fast, enterprise-grade Web Components foundation.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 36,035 | 🐛 49 | 🌐 TypeScript | 📅 2026-09-15 - Library that extends Solid adding Custom Web Components and extensions.
...
* [pion](https://github.com/pionjs/pion) ⭐ 98 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-13 - React's Hooks API for web components with lit-html.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,902 | 🐛 1,028 | 🌐 JavaScript | 📅 2026-08-26 - Web component framework to easily create user-first experiences for the web.
...
* [custom-element-boilerplate](https://github.com/github/custom-element-boilerplate) ⭐ 177 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-14 - Boilerplate for creating a custom element.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 6,153 | 🐛 2,811 | 🌐 HTML | 📅 2026-09-15
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,788 | 🐛 415 | 🌐 JavaScript | 📅 2026-09-14 - Shadow DOM polyfill by [LWC](https://lwc.dev).
