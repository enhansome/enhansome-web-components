...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 6,170 | 🐛 2,823 | 🌐 HTML | 📅 2026-09-25
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 6,170 | 🐛 2,823 | 🌐 HTML | 📅 2026-09-25
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 6,170 | 🐛 2,823 | 🌐 HTML | 📅 2026-09-25
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow/part) ⭐ 6,170 | 🐛 2,823 | 🌐 HTML | 📅 2026-09-25
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 20,014 | 🐛 186 | 🌐 JavaScript | 📅 2026-09-12 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,259 | 🐛 119 | 🌐 TypeScript | 📅 2026-07-07 - Web component for rendering interactive 3D models.
* [`<lite-youtube>`](https://github.com/paulirish/lite-youtube-embed) ⭐ 6,352 | 🐛 27 | 🌐 HTML | 📅 2025-11-10 - Lite YouTube embed with a focus on visual performance.
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 6,042 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-25 - Web component for drawing patterns with CSS.
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,723 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-24 - Web component for chat with AI capabilities.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 185 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,626 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-14 quickly into your page using custom elements.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,902 | 🐛 1,030 | 🌐 JavaScript | 📅 2026-08-26 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,964 | 🐛 172 | 🌐 JavaScript | 📅 2026-09-24 - Set of highly performant, accessible and flexible Web Components.
...
* [Web Awesome](https://github.com/shoelace-style/webawesome) ⭐ 1,340 | 🐛 76 | 🌐 TypeScript | 📅 2026-09-24 - Open source library of web components from Font Awesome.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 582 | 🐛 915 | 🌐 JavaScript | 📅 2026-09-25 - Evolving set of high-quality web components for building business web applications.
...
* [VSCode Elements](https://github.com/vscode-elements/elements) ⭐ 458 | 🐛 62 | 🌐 HTML | 📅 2026-09-24 - Web component library for developing Visual Studio Code extensions.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 274 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-24 - ELMS:LN produced web components for any project.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 79 | 🐛 52 | 🌐 JavaScript | 📅 2026-09-25 - Collection of web components for building Brightspace applications.
...
* [Mutation testing elements](https://github.com/stryker-mutator/mutation-testing-elements) ⭐ 29 | 🐛 47 | 🌐 HTML | 📅 2026-09-25 - A schema for mutation testing results with the web components to visualize it.
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 73 | 🌐 JavaScript | 📅 2026-09-25 - Components for building web applications with Nuxeo using Web Components.
...
* [seele](https://github.com/vollowx/seele) ⭐ 18 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-25 - An extensible Web Components library, with Material Design 3 components pre-provided.
* [TEI Publisher Components](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 74 | 🌐 JavaScript | 📅 2026-09-24 - Collection of web components used by TEI Publisher and apps generated by it.
...
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 11 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-25 - Web components library for Sme.UP.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 20,294 | 🐛 807 | 🌐 TypeScript | 📅 2026-09-25 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 11,273 | 🐛 185 | 🌐 SCSS | 📅 2026-09-25 - Material Design implemented as Web Components.
* [UI5 Web Components](https://github.com/UI5/webcomponents) ⭐ 1,781 | 🐛 229 | 🌐 TypeScript | 📅 2026-09-25 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,540 | 🐛 249 | 🌐 TypeScript | 📅 2026-09-25 - Adobe Spectrum design language implementation built with Web Components.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 376 | 🐛 100 | 🌐 TypeScript | 📅 2026-09-25 - Web Components implementing Siemens iX design system.
* [Calcite Design System](https://github.com/Esri/calcite-design-system) ⭐ 373 | 🐛 992 | 🌐 TypeScript | 📅 2026-09-25 - Web Components for Esri's Calcite design framework.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 152 | 🐛 146 | 🌐 HTML | 📅 2026-09-24 - Web components for building uniform experiences with the Red Hat brand.
...
* [NVIDIA Elements](https://github.com/nvidia/elements) ⭐ 88 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-25 - The Design Language and UI Agent Harness for AI/ML Factories, Robotics, and Autonomous Vehicles.
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 71 | 🐛 63 | 🌐 TypeScript | 📅 2026-09-24 - Library of Web Components adhering to the Forge Design System.
* [Lyne Components](https://github.com/sbb-design-systems/lyne-components) ⭐ 66 | 🐛 73 | 🌐 TypeScript | 📅 2026-09-25 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Stencil](https://github.com/stenciljs/core) ⭐ 13,130 | 🐛 177 | 🌐 TypeScript | 📅 2026-09-24 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/main/packages/fast-element) ⭐ 9,674 | 🐛 74 | 🌐 TypeScript | 📅 2026-09-25 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
...
* [Joist](https://github.com/joist-framework/joist) ⭐ 134 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-25 - Set of small libraries designed to add the bare minimum to web components to make you productive.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 36,073 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-25 - Library that extends Solid adding Custom Web Components and extensions.
* [hybrids](https://github.com/hybridsjs/hybrids) ⭐ 3,178 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-25 - UI library for creating Web Components with simple and functional API.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,902 | 🐛 1,030 | 🌐 JavaScript | 📅 2026-08-26 - Web component framework to easily create user-first experiences for the web.
...
* [cypress-lit](https://github.com/simonireilly/cypress-lit) ⭐ 25 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-25 - Test your Lit elements and native web components in Cypress with all the modern browsers.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 6,170 | 🐛 2,823 | 🌐 HTML | 📅 2026-09-25
