...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 6,171 | 🐛 2,820 | 🌐 HTML | 📅 2026-09-24
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 6,171 | 🐛 2,820 | 🌐 HTML | 📅 2026-09-24
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 6,171 | 🐛 2,820 | 🌐 HTML | 📅 2026-09-24
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow/part) ⭐ 6,171 | 🐛 2,820 | 🌐 HTML | 📅 2026-09-24
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 20,015 | 🐛 186 | 🌐 JavaScript | 📅 2026-09-12 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,259 | 🐛 118 | 🌐 TypeScript | 📅 2026-07-07 - Web component for rendering interactive 3D models.
...
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 6,042 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-24 - Web component for drawing patterns with CSS.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 185 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,625 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-14 quickly into your page using custom elements.
...
* [Wired Elements](https://github.com/wiredjs/wired-elements) ⭐ 10,831 | 🐛 36 | 🌐 TypeScript | 📅 2023-10-07 - Set of common UI elements with a hand-drawn, sketchy look.
...
* [Web Awesome](https://github.com/shoelace-style/webawesome) ⭐ 1,339 | 🐛 46 | 🌐 TypeScript | 📅 2026-09-24 - Open source library of web components from Font Awesome.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 582 | 🐛 912 | 🌐 JavaScript | 📅 2026-09-24 - Evolving set of high-quality web components for building business web applications.
...
* [VSCode Elements](https://github.com/vscode-elements/elements) ⭐ 458 | 🐛 62 | 🌐 HTML | 📅 2026-09-23 - Web component library for developing Visual Studio Code extensions.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 274 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-23 - ELMS:LN produced web components for any project.
...
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 240 | 🐛 329 | 🌐 JavaScript | 📅 2026-09-24 - Collection of Web Components made by Clever Cloud.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 170 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-24 - Complete library of UI components from Infragistics.
...
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 152 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-24 - Collection of user interface web components for Umbraco CMS.
...
* [PlayCanvas Web Components](https://github.com/playcanvas/web-components) ⭐ 110 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-24 - Custom elements for building 3D interactive web apps with the PlayCanvas Engine.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 79 | 🐛 49 | 🌐 JavaScript | 📅 2026-09-24 - Collection of web components for building Brightspace applications.
...
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 11 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-23 - Web components library for Sme.UP.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 20,293 | 🐛 816 | 🌐 TypeScript | 📅 2026-09-24 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 11,272 | 🐛 184 | 🌐 SCSS | 📅 2026-09-23 - Material Design implemented as Web Components.
* [UI5 Web Components](https://github.com/UI5/webcomponents) ⭐ 1,781 | 🐛 227 | 🌐 TypeScript | 📅 2026-09-24 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,539 | 🐛 247 | 🌐 TypeScript | 📅 2026-09-24 - Adobe Spectrum design language implementation built with Web Components.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 375 | 🐛 99 | 🌐 TypeScript | 📅 2026-09-24 - Web Components implementing Siemens iX design system.
* [Calcite Design System](https://github.com/Esri/calcite-design-system) ⭐ 373 | 🐛 991 | 🌐 TypeScript | 📅 2026-09-24 - Web Components for Esri's Calcite design framework.
...
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/main/web-components) ⭐ 214 | 🐛 52 | 🌐 SCSS | 📅 2026-09-24 - Set of UI components based on Momentum Design.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 152 | 🐛 145 | 🌐 HTML | 📅 2026-09-23 - Web components for building uniform experiences with the Red Hat brand.
...
* [NVIDIA Elements](https://github.com/nvidia/elements) ⭐ 88 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-24 - The Design Language and UI Agent Harness for AI/ML Factories, Robotics, and Autonomous Vehicles.
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 71 | 🐛 76 | 🌐 TypeScript | 📅 2026-09-23 - Library of Web Components adhering to the Forge Design System.
* [Lyne Components](https://github.com/sbb-design-systems/lyne-components) ⭐ 66 | 🐛 75 | 🌐 TypeScript | 📅 2026-09-24 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Omi](https://github.com/Tencent/omi) ⭐ 13,271 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-24 - Next generation web framework in 4kb JavaScript (Web Components + JSX + Proxy + Store + Path Updating).
* [Stencil](https://github.com/stenciljs/core) ⭐ 13,129 | 🐛 182 | 🌐 TypeScript | 📅 2026-09-24 - Compiler for generating Web Components.
...
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,790 | 🐛 411 | 🌐 JavaScript | 📅 2026-09-22 - blazing fast, enterprise-grade Web Components foundation.
...
* [Joist](https://github.com/joist-framework/joist) ⭐ 134 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-23 - Set of small libraries designed to add the bare minimum to web components to make you productive.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 36,073 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-24 - Library that extends Solid adding Custom Web Components and extensions.
* [hybrids](https://github.com/hybridsjs/hybrids) ⭐ 3,178 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-17 - UI library for creating Web Components with simple and functional API.
...
* [nuxt-custom-elements](https://github.com/GrabarzUndPartner/nuxt-custom-elements) ⭐ 83 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-23 - Export your project components as custom elements for integration into external pages.
...
* [cypress-lit](https://github.com/simonireilly/cypress-lit) ⭐ 25 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-24 - Test your Lit elements and native web components in Cypress with all the modern browsers.
...
* [web-component-analyzer](https://github.com/runem/web-component-analyzer) ⭐ 520 | 🐛 96 | 🌐 TypeScript | 📅 2023-11-24 - CLI that analyzes web components and emits documentation / diagnostics.
...
* [Web Components Codemods](https://github.com/kcmr/web-components-codemods) ⭐ 10 | 🐛 37 | 🌐 JavaScript | 📅 2026-09-24 - Codemods for Web Components.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 6,171 | 🐛 2,820 | 🌐 HTML | 📅 2026-09-24
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,790 | 🐛 411 | 🌐 JavaScript | 📅 2026-09-22 - Shadow DOM polyfill by [LWC](https://lwc.dev).
