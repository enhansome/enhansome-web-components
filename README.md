...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 6,145 | 🐛 2,804 | 🌐 HTML | 📅 2026-09-09
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 6,145 | 🐛 2,804 | 🌐 HTML | 📅 2026-09-09
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 6,145 | 🐛 2,804 | 🌐 HTML | 📅 2026-09-09
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow/part) ⭐ 6,145 | 🐛 2,804 | 🌐 HTML | 📅 2026-09-09
...
* [Nude UI](https://github.com/LeaVerou/nudeui) ⭐ 233 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-08 - Collection of accessible, customizable, ultra-light web components.
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 20,004 | 🐛 188 | 🌐 JavaScript | 📅 2026-09-09 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,232 | 🐛 117 | 🌐 TypeScript | 📅 2026-07-07 - Web component for rendering interactive 3D models.
...
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 6,035 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-08 - Web component for drawing patterns with CSS.
...
* [`<phantom-ui>`](https://github.com/Aejkatappaja/phantom-ui) ⭐ 795 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-31 - Skeleton loader that measures your real DOM to render matching shimmer placeholders.
...
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 193 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-29 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 185 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,609 | 🐛 14 | 🌐 JavaScript | 📅 2026-08-26 quickly into your page using custom elements.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,904 | 🐛 1,027 | 🌐 JavaScript | 📅 2026-08-26 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,961 | 🐛 187 | 🌐 JavaScript | 📅 2026-09-08 - Set of highly performant, accessible and flexible Web Components.
...
* [Web Awesome](https://github.com/shoelace-style/webawesome) ⭐ 1,307 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-08 - Open source library of web components from Font Awesome.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 581 | 🐛 930 | 🌐 JavaScript | 📅 2026-09-09 - Evolving set of high-quality web components for building business web applications.
* [Smart Web Components](https://github.com/HTMLElements/smart-webcomponents) ⭐ 484 | 🐛 16 | 🌐 CSS | 📅 2026-09-08 - Web components for business applications.
* [VSCode Elements](https://github.com/vscode-elements/elements) ⭐ 457 | 🐛 60 | 🌐 HTML | 📅 2026-09-08 - Web component library for developing Visual Studio Code extensions.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 274 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-08 - ELMS:LN produced web components for any project.
...
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 240 | 🐛 328 | 🌐 JavaScript | 📅 2026-09-09 - Collection of Web Components made by Clever Cloud.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 169 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-09 - Complete library of UI components from Infragistics.
...
* [PlayCanvas Web Components](https://github.com/playcanvas/web-components) ⭐ 109 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-08 - Custom elements for building 3D interactive web apps with the PlayCanvas Engine.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 79 | 🐛 45 | 🌐 JavaScript | 📅 2026-09-08 - Collection of web components for building Brightspace applications.
...
* [One Platform Components](https://github.com/1-Platform/op-components) ⭐ 33 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-08 - Set of web components for Red Hat One Platform.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 65 | 🌐 JavaScript | 📅 2026-09-09 - Components for building web applications with Nuxeo using Web Components.
...
* [TEI Publisher Components](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 71 | 🌐 JavaScript | 📅 2026-09-07 - Collection of web components used by TEI Publisher and apps generated by it.
...
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 11 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-09 - Web components library for Sme.UP.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 20,258 | 🐛 798 | 🌐 TypeScript | 📅 2026-09-09 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 11,232 | 🐛 187 | 🌐 SCSS | 📅 2026-09-09 - Material Design implemented as Web Components.
* [UI5 Web Components](https://github.com/UI5/webcomponents) ⭐ 1,775 | 🐛 221 | 🌐 TypeScript | 📅 2026-09-09 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,535 | 🐛 231 | 🌐 TypeScript | 📅 2026-09-09 - Adobe Spectrum design language implementation built with Web Components.
...
* [Calcite Design System](https://github.com/Esri/calcite-design-system) ⭐ 373 | 🐛 984 | 🌐 TypeScript | 📅 2026-09-09 - Web Components for Esri's Calcite design framework.
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 371 | 🐛 99 | 🌐 TypeScript | 📅 2026-09-09 - Web Components implementing Siemens iX design system.
* [Crayons](https://github.com/freshdesk/crayons) ⭐ 248 | 🐛 47 | 🌐 JavaScript | 📅 2026-09-09 - Collection of web components that adheres to the Freshworks Design System.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 149 | 🐛 200 | 🌐 HTML | 📅 2026-09-08 - Web components for building uniform experiences with the Red Hat brand.
...
* [NVIDIA Elements](https://github.com/nvidia/elements) ⭐ 85 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-09 - The Design Language and UI Agent Harness for AI/ML Factories, Robotics, and Autonomous Vehicles.
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 68 | 🐛 67 | 🌐 TypeScript | 📅 2026-09-04 - Library of Web Components adhering to the Forge Design System.
* [Lyne Components](https://github.com/sbb-design-systems/lyne-components) ⭐ 66 | 🐛 73 | 🌐 TypeScript | 📅 2026-09-09 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Omi](https://github.com/Tencent/omi) ⭐ 13,263 | 🐛 69 | 🌐 TypeScript | 📅 2026-03-27 - Next generation web framework in 4kb JavaScript (Web Components + JSX + Proxy + Store + Path Updating).
* [Stencil](https://github.com/stenciljs/core) ⭐ 13,127 | 🐛 180 | 🌐 TypeScript | 📅 2026-09-09 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/main/packages/fast-element) ⭐ 9,671 | 🐛 82 | 🌐 TypeScript | 📅 2026-09-09 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,786 | 🐛 414 | 🌐 JavaScript | 📅 2026-09-08 - blazing fast, enterprise-grade Web Components foundation.
...
* [Joist](https://github.com/joist-framework/joist) ⭐ 134 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-08 - Set of small libraries designed to add the bare minimum to web components to make you productive.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 36,001 | 🐛 31 | 🌐 TypeScript | 📅 2026-09-09 - Library that extends Solid adding Custom Web Components and extensions.
* [hybrids](https://github.com/hybridsjs/hybrids) ⭐ 3,174 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-09 - UI library for creating Web Components with simple and functional API.
...
* [nuxt-custom-elements](https://github.com/GrabarzUndPartner/nuxt-custom-elements) ⭐ 83 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-07 - Export your project components as custom elements for integration into external pages.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,904 | 🐛 1,027 | 🌐 JavaScript | 📅 2026-08-26 - Web component framework to easily create user-first experiences for the web.
...
* [Web Components Codemods](https://github.com/kcmr/web-components-codemods) ⭐ 10 | 🐛 37 | 🌐 JavaScript | 📅 2026-09-07 - Codemods for Web Components.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 6,145 | 🐛 2,804 | 🌐 HTML | 📅 2026-09-09
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,786 | 🐛 414 | 🌐 JavaScript | 📅 2026-09-08 - Shadow DOM polyfill by [LWC](https://lwc.dev).
