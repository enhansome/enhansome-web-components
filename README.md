...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 6,112 | 🐛 2,813 | 🌐 HTML | 📅 2026-08-21
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 6,112 | 🐛 2,813 | 🌐 HTML | 📅 2026-08-21
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 6,112 | 🐛 2,813 | 🌐 HTML | 📅 2026-08-21
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 6,112 | 🐛 2,813 | 🌐 HTML | 📅 2026-08-21
...
* [howto-components](https://github.com/GoogleChromeLabs/howto-components) ⭐ 873 | 🐛 52 | 🌐 JavaScript | 📅 2026-08-11 - Collection of web components that implement common web UI patterns.
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 20,001 | 🐛 184 | 🌐 JavaScript | 📅 2026-08-11 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,205 | 🐛 117 | 🌐 TypeScript | 📅 2026-07-07 - Web component for rendering interactive 3D models.
* [`<lite-youtube>`](https://github.com/paulirish/lite-youtube-embed) ⭐ 6,346 | 🐛 27 | 🌐 HTML | 📅 2025-11-10 - Lite YouTube embed with a focus on visual performance.
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,707 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-20 - Web component for chat with AI capabilities.
...
* [`<phantom-ui>`](https://github.com/Aejkatappaja/phantom-ui) ⭐ 787 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-31 - Skeleton loader that measures your real DOM to render matching shimmer placeholders.
...
* [`<progressive-image>`](https://github.com/andreruffert/progressive-image-element) ⭐ 270 | 🐛 2 | 🌐 HTML | 📅 2026-08-21 - Custom element to progressively enhance image placeholders.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,588 | 🐛 13 | 🌐 JavaScript | 📅 2026-08-15 quickly into your page using custom elements.
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 180 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-16 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,910 | 🐛 1,016 | 🌐 JavaScript | 📅 2026-08-20 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
...
* [LDRS](https://github.com/GriffinJohnston/ldrs) ⭐ 2,204 | 🐛 1 | 🌐 TypeScript | 📅 2025-10-22 - Lightweight, customizable loading animations/spinners.
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,960 | 🐛 188 | 🌐 JavaScript | 📅 2026-08-20 - Set of highly performant, accessible and flexible Web Components.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 579 | 🐛 924 | 🌐 JavaScript | 📅 2026-08-20 - Evolving set of high-quality web components for building business web applications.
...
* [Wokwi Elements](https://github.com/wokwi/wokwi-elements) ⭐ 259 | 🐛 26 | 🌐 TypeScript | 📅 2026-08-06 - Web Components for Arduino and various electronic parts.
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 240 | 🐛 325 | 🌐 JavaScript | 📅 2026-08-20 - Collection of Web Components made by Clever Cloud.
...
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 150 | 🐛 56 | 🌐 TypeScript | 📅 2026-08-21 - Collection of user interface web components for Umbraco CMS.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 106 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-20 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 79 | 🐛 51 | 🌐 JavaScript | 📅 2026-08-20 - Collection of web components for building Brightspace applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 79 | 🌐 JavaScript | 📅 2026-08-21 - Components for building web applications with Nuxeo using Web Components.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 33 | 🌐 TypeScript | 📅 2026-08-21 - Ser of web components used by Equinor Fusion.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 20,222 | 🐛 754 | 🌐 TypeScript | 📅 2026-08-21 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 11,187 | 🐛 179 | 🌐 SCSS | 📅 2026-08-19 - Material Design implemented as Web Components.
...
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,769 | 🐛 220 | 🌐 TypeScript | 📅 2026-08-21 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,528 | 🐛 236 | 🌐 TypeScript | 📅 2026-08-21 - Adobe Spectrum design language implementation built with Web Components.
...
* [PatternFly Elements](https://github.com/patternfly/patternfly-elements) ⭐ 393 | 🐛 170 | 🌐 TypeScript | 📅 2026-08-20 - Collection of flexible and lightweight Web Components based on the Unified Design Kit.
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 373 | 🐛 1,002 | 🌐 TypeScript | 📅 2026-08-21 - Shared Web Components for Esri's Calcite design framework.
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 367 | 🐛 97 | 🌐 TypeScript | 📅 2026-08-20 - Web Components implementing Siemens iX design system.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 148 | 🐛 196 | 🌐 HTML | 📅 2026-08-20 - Web components for building uniform experiences with the Red Hat brand.
* [OutlineJS](https://github.com/phase2/outline) ⭐ 131 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-11 - Web component based design system starter kit.
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 131 | 🐛 72 | 🌐 TypeScript | 📅 2026-08-20 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [NVIDIA Elements](https://github.com/nvidia/elements) ⭐ 78 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-21 - The Design Language and UI Agent Harness for AI/ML Factories, Robotics, and Autonomous Vehicles.
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 68 | 🐛 62 | 🌐 TypeScript | 📅 2026-08-20 - Library of Web Components adhering to the Forge Design System.
* [Lyne Components](https://github.com/lyne-design-system/lyne-components) ⭐ 66 | 🐛 73 | 🌐 TypeScript | 📅 2026-08-21 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Omi](https://github.com/Tencent/omi) ⭐ 13,255 | 🐛 69 | 🌐 TypeScript | 📅 2026-03-27 - Next generation web framework in 4kb JavaScript (Web Components + JSX + Proxy + Store + Path Updating).
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,122 | 🐛 175 | 🌐 TypeScript | 📅 2026-08-20 - Compiler for generating Web Components.
...
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,784 | 🐛 415 | 🌐 JavaScript | 📅 2026-08-20 - blazing fast, enterprise-grade Web Components foundation.
...
* [Joist](https://github.com/joist-framework/joist) ⭐ 134 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-20 - Set of small libraries designed to add the bare minimum to web components to make you productive.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,887 | 🐛 26 | 🌐 TypeScript | 📅 2026-08-21 - Library that extends Solid adding Custom Web Components and extensions.
* [hybrids](https://github.com/hybridsjs/hybrids) ⭐ 3,175 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-07 - UI library for creating Web Components with simple and functional API.
* [haunted](https://github.com/matthewp/haunted) ⭐ 2,719 | 🐛 62 | 🌐 TypeScript | 📅 2026-08-17 - React's Hooks API implemented for web components.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,910 | 🐛 1,016 | 🌐 JavaScript | 📅 2026-08-20 - Web component framework to easily create user-first experiences for the web.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 6,112 | 🐛 2,813 | 🌐 HTML | 📅 2026-08-21

### Constructable Stylesheet Objects

* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 6,112 | 🐛 2,813 | 🌐 HTML | 📅 2026-08-21
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,784 | 🐛 415 | 🌐 JavaScript | 📅 2026-08-20 - Shadow DOM polyfill by [LWC](https://lwc.dev).
