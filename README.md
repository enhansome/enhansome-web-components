...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 6,171 | 🐛 2,807 | 🌐 HTML | 📅 2026-09-23
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 6,171 | 🐛 2,807 | 🌐 HTML | 📅 2026-09-23
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 6,171 | 🐛 2,807 | 🌐 HTML | 📅 2026-09-23
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow/part) ⭐ 6,171 | 🐛 2,807 | 🌐 HTML | 📅 2026-09-23
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 20,013 | 🐛 186 | 🌐 JavaScript | 📅 2026-09-12 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,256 | 🐛 117 | 🌐 TypeScript | 📅 2026-07-07 - Web component for rendering interactive 3D models.
...
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 6,041 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-20 - Web component for drawing patterns with CSS.
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,722 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-23 - Web component for chat with AI capabilities.
...
* [`<emoji-picker>`](https://github.com/nolanlawson/emoji-picker-element) ⭐ 1,757 | 🐛 38 | 🌐 JavaScript | 📅 2026-06-08 - Lightweight emoji picker, distributed as a web component.
...
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 200 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-13 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 185 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,623 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-14 quickly into your page using custom elements.
...
* [`<range-slider>`](https://github.com/andreruffert/range-slider-element) ⭐ 93 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-22 - Accessible range slider custom element with keyboard support.
* [`<pdfjs-viewer-element>`](https://github.com/alekswebnet/pdfjs-viewer-element) ⭐ 79 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-22 - Custom element that embeds PDF.js default viewer.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,902 | 🐛 1,029 | 🌐 JavaScript | 📅 2026-08-26 - Web component framework for easily creating user-first websites, stories, ads, emails and more.
* [Wired Elements](https://github.com/wiredjs/wired-elements) ⭐ 10,830 | 🐛 36 | 🌐 TypeScript | 📅 2023-10-07 - Set of common UI elements with a hand-drawn, sketchy look.
* [github-elements](https://github.com/github/github-elements) ⭐ 2,902 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-14 - GitHub's Web Component collection.
* [LDRS](https://github.com/GriffinJohnston/ldrs) ⭐ 2,215 | 🐛 1 | 🌐 TypeScript | 📅 2025-10-22 - Lightweight, customizable loading animations/spinners.
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,964 | 🐛 171 | 🌐 JavaScript | 📅 2026-09-23 - Set of highly performant, accessible and flexible Web Components.
...
* [Web Awesome](https://github.com/shoelace-style/webawesome) ⭐ 1,332 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-22 - Open source library of web components from Font Awesome.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 582 | 🐛 925 | 🌐 JavaScript | 📅 2026-09-23 - Evolving set of high-quality web components for building business web applications.
...
* [VSCode Elements](https://github.com/vscode-elements/elements) ⭐ 457 | 🐛 62 | 🌐 HTML | 📅 2026-09-21 - Web component library for developing Visual Studio Code extensions.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 274 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-22 - ELMS:LN produced web components for any project.
...
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 240 | 🐛 331 | 🌐 JavaScript | 📅 2026-09-23 - Collection of Web Components made by Clever Cloud.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 170 | 🐛 36 | 🌐 TypeScript | 📅 2026-09-23 - Complete library of UI components from Infragistics.
...
* [PlayCanvas Web Components](https://github.com/playcanvas/web-components) ⭐ 110 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-23 - Custom elements for building 3D interactive web apps with the PlayCanvas Engine.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 79 | 🐛 51 | 🌐 JavaScript | 📅 2026-09-23 - Collection of web components for building Brightspace applications.
...
* [One Platform Components](https://github.com/1-Platform/op-components) ⭐ 34 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-19 - Set of web components for Red Hat One Platform.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 68 | 🌐 JavaScript | 📅 2026-09-23 - Components for building web applications with Nuxeo using Web Components.
* [Morpheus](https://github.com/romshark/morpheus) ⭐ 28 | 🐛 2 | 🌐 templ | 📅 2026-08-05 - An experimental web components UI kit.
...
* [TEI Publisher Components](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 72 | 🌐 JavaScript | 📅 2026-09-22 - Collection of web components used by TEI Publisher and apps generated by it.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-22 - Ser of web components used by Equinor Fusion.
...
* [Ketch.UP](https://github.com/smeup/ketchup) ⭐ 11 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-23 - Web components library for Sme.UP.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 20,292 | 🐛 816 | 🌐 TypeScript | 📅 2026-09-23 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 11,268 | 🐛 185 | 🌐 SCSS | 📅 2026-09-23 - Material Design implemented as Web Components.
* [UI5 Web Components](https://github.com/UI5/webcomponents) ⭐ 1,780 | 🐛 217 | 🌐 TypeScript | 📅 2026-09-23 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,539 | 🐛 244 | 🌐 TypeScript | 📅 2026-09-23 - Adobe Spectrum design language implementation built with Web Components.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 375 | 🐛 100 | 🌐 TypeScript | 📅 2026-09-23 - Web Components implementing Siemens iX design system.
* [Calcite Design System](https://github.com/Esri/calcite-design-system) ⭐ 373 | 🐛 993 | 🌐 TypeScript | 📅 2026-09-23 - Web Components for Esri's Calcite design framework.
...
* [Momentum UI Web Components](https://github.com/momentum-design/momentum-ui/tree/main/web-components) ⭐ 214 | 🐛 53 | 🌐 SCSS | 📅 2026-09-23 - Set of UI components based on Momentum Design.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 152 | 🐛 148 | 🌐 HTML | 📅 2026-09-22 - Web components for building uniform experiences with the Red Hat brand.
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 132 | 🐛 74 | 🌐 TypeScript | 📅 2026-09-22 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
* [OutlineJS](https://github.com/phase2/outline) ⭐ 131 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-11 - Web component based design system starter kit.
* [NVIDIA Elements](https://github.com/nvidia/elements) ⭐ 88 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-23 - The Design Language and UI Agent Harness for AI/ML Factories, Robotics, and Autonomous Vehicles.
...
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 71 | 🐛 84 | 🌐 TypeScript | 📅 2026-09-23 - Library of Web Components adhering to the Forge Design System.
* [Lyne Components](https://github.com/sbb-design-systems/lyne-components) ⭐ 66 | 🐛 76 | 🌐 TypeScript | 📅 2026-09-23 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Omi](https://github.com/Tencent/omi) ⭐ 13,270 | 🐛 70 | 🌐 TypeScript | 📅 2026-03-27 - Next generation web framework in 4kb JavaScript (Web Components + JSX + Proxy + Store + Path Updating).
* [Stencil](https://github.com/stenciljs/core) ⭐ 13,129 | 🐛 178 | 🌐 TypeScript | 📅 2026-09-23 - Compiler for generating Web Components.
...
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,790 | 🐛 412 | 🌐 JavaScript | 📅 2026-09-22 - blazing fast, enterprise-grade Web Components foundation.
...
* [Joist](https://github.com/joist-framework/joist) ⭐ 134 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-19 - Set of small libraries designed to add the bare minimum to web components to make you productive.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 36,069 | 🐛 48 | 🌐 TypeScript | 📅 2026-09-23 - Library that extends Solid adding Custom Web Components and extensions.
...
* [pion](https://github.com/pionjs/pion) ⭐ 82 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-22 - React's Hooks API for web components with lit-html.
...
* [AMP](https://github.com/ampproject/amphtml) ⭐ 14,902 | 🐛 1,029 | 🌐 JavaScript | 📅 2026-08-26 - Web component framework to easily create user-first experiences for the web.
...
* [cypress-lit](https://github.com/simonireilly/cypress-lit) ⭐ 25 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-23 - Test your Lit elements and native web components in Cypress with all the modern browsers.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 6,171 | 🐛 2,807 | 🌐 HTML | 📅 2026-09-23
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,790 | 🐛 412 | 🌐 JavaScript | 📅 2026-09-22 - Shadow DOM polyfill by [LWC](https://lwc.dev).
