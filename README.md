...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 6,146 | 🐛 2,805 | 🌐 HTML | 📅 2026-09-10
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 6,146 | 🐛 2,805 | 🌐 HTML | 📅 2026-09-10
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 6,146 | 🐛 2,805 | 🌐 HTML | 📅 2026-09-10
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow/part) ⭐ 6,146 | 🐛 2,805 | 🌐 HTML | 📅 2026-09-10
...
* [`<trix-editor>`](https://github.com/basecamp/trix) ⭐ 20,004 | 🐛 183 | 🌐 JavaScript | 📅 2026-09-10 - Rich text editor custom element for everyday writing.
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,233 | 🐛 117 | 🌐 TypeScript | 📅 2026-07-07 - Web component for rendering interactive 3D models.
...
* [`<css-doodle>`](https://github.com/css-doodle/css-doodle) ⭐ 6,036 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-08 - Web component for drawing patterns with CSS.
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,712 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-06 - Web component for chat with AI capabilities.
...
* [`<phantom-ui>`](https://github.com/Aejkatappaja/phantom-ui) ⭐ 796 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-31 - Skeleton loader that measures your real DOM to render matching shimmer placeholders.
...
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 194 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-10 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,962 | 🐛 189 | 🌐 JavaScript | 📅 2026-09-10 - Set of highly performant, accessible and flexible Web Components.
...
* [Lume](https://github.com/lume/lume) ⭐ 1,517 | 🐛 123 | 🌐 TypeScript | 📅 2026-09-08 - Custom elements for 3D graphics. Built with Three.js for WebGL/WebGPU rendering, and Solid.js for reactivity and templating.
* [Web Awesome](https://github.com/shoelace-style/webawesome) ⭐ 1,307 | 🐛 47 | 🌐 TypeScript | 📅 2026-09-09 - Open source library of web components from Font Awesome.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 581 | 🐛 928 | 🌐 JavaScript | 📅 2026-09-10 - Evolving set of high-quality web components for building business web applications.
* [Smart Web Components](https://github.com/HTMLElements/smart-webcomponents) ⭐ 484 | 🐛 17 | 🌐 CSS | 📅 2026-09-10 - Web components for business applications.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 274 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-09 - ELMS:LN produced web components for any project.
...
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 240 | 🐛 330 | 🌐 JavaScript | 📅 2026-09-10 - Collection of Web Components made by Clever Cloud.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 169 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-10 - Complete library of UI components from Infragistics.
...
* [Dile Components](https://github.com/Polydile/dile-components) ⭐ 106 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-09 - General use Web Components for websites and applications.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 79 | 🐛 48 | 🌐 JavaScript | 📅 2026-09-09 - Collection of web components for building Brightspace applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 66 | 🌐 JavaScript | 📅 2026-09-10 - Components for building web applications with Nuxeo using Web Components.
* [Morpheus](https://github.com/romshark/morpheus) ⭐ 23 | 🐛 2 | 🌐 templ | 📅 2026-08-05 - An experimental web components UI kit.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-08 - Ser of web components used by Equinor Fusion.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 20,262 | 🐛 800 | 🌐 TypeScript | 📅 2026-09-09 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 11,233 | 🐛 187 | 🌐 SCSS | 📅 2026-09-10 - Material Design implemented as Web Components.
* [UI5 Web Components](https://github.com/UI5/webcomponents) ⭐ 1,775 | 🐛 220 | 🌐 TypeScript | 📅 2026-09-10 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,535 | 🐛 233 | 🌐 TypeScript | 📅 2026-09-10 - Adobe Spectrum design language implementation built with Web Components.
...
* [Calcite Design System](https://github.com/Esri/calcite-design-system) ⭐ 373 | 🐛 988 | 🌐 TypeScript | 📅 2026-09-10 - Web Components for Esri's Calcite design framework.
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 372 | 🐛 118 | 🌐 TypeScript | 📅 2026-09-10 - Web Components implementing Siemens iX design system.
* [Crayons](https://github.com/freshdesk/crayons) ⭐ 248 | 🐛 47 | 🌐 JavaScript | 📅 2026-09-10 - Collection of web components that adheres to the Freshworks Design System.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 149 | 🐛 182 | 🌐 HTML | 📅 2026-09-09 - Web components for building uniform experiences with the Red Hat brand.
* [OutlineJS](https://github.com/phase2/outline) ⭐ 131 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-11 - Web component based design system starter kit.
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 131 | 🐛 78 | 🌐 TypeScript | 📅 2026-09-08 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [NVIDIA Elements](https://github.com/nvidia/elements) ⭐ 85 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-10 - The Design Language and UI Agent Harness for AI/ML Factories, Robotics, and Autonomous Vehicles.
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 68 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-10 - Library of Web Components adhering to the Forge Design System.
* [Lyne Components](https://github.com/sbb-design-systems/lyne-components) ⭐ 66 | 🐛 76 | 🌐 TypeScript | 📅 2026-09-10 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Omi](https://github.com/Tencent/omi) ⭐ 13,262 | 🐛 69 | 🌐 TypeScript | 📅 2026-03-27 - Next generation web framework in 4kb JavaScript (Web Components + JSX + Proxy + Store + Path Updating).
* [Stencil](https://github.com/stenciljs/core) ⭐ 13,128 | 🐛 183 | 🌐 TypeScript | 📅 2026-09-10 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/main/packages/fast-element) ⭐ 9,672 | 🐛 82 | 🌐 TypeScript | 📅 2026-09-10 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,786 | 🐛 415 | 🌐 JavaScript | 📅 2026-09-09 - blazing fast, enterprise-grade Web Components foundation.
* [Panel](https://github.com/mixpanel/panel) ⭐ 274 | 🐛 31 | 🌐 JavaScript | 📅 2026-07-28 - Web Components + Virtual DOM: web standards for powerful UIs.
...
* [Joist](https://github.com/joist-framework/joist) ⭐ 134 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-10 - Set of small libraries designed to add the bare minimum to web components to make you productive.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 36,014 | 🐛 43 | 🌐 TypeScript | 📅 2026-09-10 - Library that extends Solid adding Custom Web Components and extensions.
...
* [pion](https://github.com/pionjs/pion) ⭐ 98 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-09 - React's Hooks API for web components with lit-html.
...
* [nuxt-custom-elements](https://github.com/GrabarzUndPartner/nuxt-custom-elements) ⭐ 83 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-09 - Export your project components as custom elements for integration into external pages.
...
* [Web Components Codemods](https://github.com/kcmr/web-components-codemods) ⭐ 10 | 🐛 37 | 🌐 JavaScript | 📅 2026-09-09 - Codemods for Web Components.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 6,146 | 🐛 2,805 | 🌐 HTML | 📅 2026-09-10
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,786 | 🐛 415 | 🌐 JavaScript | 📅 2026-09-09 - Shadow DOM polyfill by [LWC](https://lwc.dev).
