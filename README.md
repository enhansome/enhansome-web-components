...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 6,154 | 🐛 2,809 | 🌐 HTML | 📅 2026-09-16
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 6,154 | 🐛 2,809 | 🌐 HTML | 📅 2026-09-16
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 6,154 | 🐛 2,809 | 🌐 HTML | 📅 2026-09-16
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow/part) ⭐ 6,154 | 🐛 2,809 | 🌐 HTML | 📅 2026-09-16
...
* [Nude UI](https://github.com/LeaVerou/nudeui) ⭐ 234 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-15 - Collection of accessible, customizable, ultra-light web components.
...
* [`<deep-chat>`](https://github.com/OvidijusParsiunas/deep-chat) ⭐ 3,713 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-15 - Web component for chat with AI capabilities.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 185 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,610 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-14 quickly into your page using custom elements.
...
* [`<pdfjs-viewer-element>`](https://github.com/alekswebnet/pdfjs-viewer-element) ⭐ 78 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-16 - Custom element that embeds PDF.js default viewer.
...
* [Lion Web Components](https://github.com/ing-bank/lion) ⭐ 1,963 | 🐛 169 | 🌐 JavaScript | 📅 2026-09-16 - Set of highly performant, accessible and flexible Web Components.
...
* [Web Awesome](https://github.com/shoelace-style/webawesome) ⭐ 1,319 | 🐛 49 | 🌐 TypeScript | 📅 2026-09-16 - Open source library of web components from Font Awesome.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 582 | 🐛 926 | 🌐 JavaScript | 📅 2026-09-16 - Evolving set of high-quality web components for building business web applications.
...
* [VSCode Elements](https://github.com/vscode-elements/elements) ⭐ 457 | 🐛 61 | 🌐 HTML | 📅 2026-09-16 - Web component library for developing Visual Studio Code extensions.
...
* [LRNWebComponents](https://github.com/elmsln/lrnwebcomponents/) ⭐ 274 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-15 - ELMS:LN produced web components for any project.
...
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 240 | 🐛 329 | 🌐 JavaScript | 📅 2026-09-16 - Collection of Web Components made by Clever Cloud.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 170 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-16 - Complete library of UI components from Infragistics.
...
* [Umbraco UI Components](https://github.com/umbraco/Umbraco.UI) ⭐ 151 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-14 - Collection of user interface web components for Umbraco CMS.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 79 | 🐛 46 | 🌐 JavaScript | 📅 2026-09-15 - Collection of web components for building Brightspace applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 77 | 🌐 JavaScript | 📅 2026-09-16 - Components for building web applications with Nuxeo using Web Components.
...
* [TEI Publisher Components](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 69 | 🌐 JavaScript | 📅 2026-09-16 - Collection of web components used by TEI Publisher and apps generated by it.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-16 - Ser of web components used by Equinor Fusion.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 20,274 | 🐛 814 | 🌐 TypeScript | 📅 2026-09-16 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 11,243 | 🐛 185 | 🌐 SCSS | 📅 2026-09-15 - Material Design implemented as Web Components.
* [UI5 Web Components](https://github.com/UI5/webcomponents) ⭐ 1,776 | 🐛 223 | 🌐 TypeScript | 📅 2026-09-16 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,536 | 🐛 238 | 🌐 TypeScript | 📅 2026-09-16 - Adobe Spectrum design language implementation built with Web Components.
...
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 374 | 🐛 113 | 🌐 TypeScript | 📅 2026-09-16 - Web Components implementing Siemens iX design system.
* [Calcite Design System](https://github.com/Esri/calcite-design-system) ⭐ 373 | 🐛 981 | 🌐 TypeScript | 📅 2026-09-16 - Web Components for Esri's Calcite design framework.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 150 | 🐛 154 | 🌐 HTML | 📅 2026-09-15 - Web components for building uniform experiences with the Red Hat brand.
* [OutlineJS](https://github.com/phase2/outline) ⭐ 131 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-11 - Web component based design system starter kit.
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 131 | 🐛 75 | 🌐 TypeScript | 📅 2026-09-15 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [NVIDIA Elements](https://github.com/nvidia/elements) ⭐ 86 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-15 - The Design Language and UI Agent Harness for AI/ML Factories, Robotics, and Autonomous Vehicles.
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 70 | 🐛 72 | 🌐 TypeScript | 📅 2026-09-14 - Library of Web Components adhering to the Forge Design System.
* [Lyne Components](https://github.com/sbb-design-systems/lyne-components) ⭐ 66 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-16 - Building blocks of the Lyne Design System are based on Web Components.
...
* [Omi](https://github.com/Tencent/omi) ⭐ 13,267 | 🐛 70 | 🌐 TypeScript | 📅 2026-03-27 - Next generation web framework in 4kb JavaScript (Web Components + JSX + Proxy + Store + Path Updating).
* [Stencil](https://github.com/stenciljs/core) ⭐ 13,127 | 🐛 177 | 🌐 TypeScript | 📅 2026-09-16 - Compiler for generating Web Components.
* [FAST Element](https://github.com/microsoft/fast/tree/main/packages/fast-element) ⭐ 9,671 | 🐛 75 | 🌐 TypeScript | 📅 2026-09-14 - Lightweight library for building performant, memory-efficient, standards-compliant Web Components.
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,788 | 🐛 413 | 🌐 JavaScript | 📅 2026-09-15 - blazing fast, enterprise-grade Web Components foundation.
...
* [Joist](https://github.com/joist-framework/joist) ⭐ 134 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-16 - Set of small libraries designed to add the bare minimum to web components to make you productive.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 36,038 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-16 - Library that extends Solid adding Custom Web Components and extensions.
...
* [nuxt-custom-elements](https://github.com/GrabarzUndPartner/nuxt-custom-elements) ⭐ 83 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-16 - Export your project components as custom elements for integration into external pages.
...
* [custom-element-boilerplate](https://github.com/github/custom-element-boilerplate) ⭐ 177 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-15 - Boilerplate for creating a custom element.
...
* [Web Components Codemods](https://github.com/kcmr/web-components-codemods) ⭐ 10 | 🐛 37 | 🌐 JavaScript | 📅 2026-09-15 - Codemods for Web Components.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 6,154 | 🐛 2,809 | 🌐 HTML | 📅 2026-09-16
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,788 | 🐛 413 | 🌐 JavaScript | 📅 2026-09-15 - Shadow DOM polyfill by [LWC](https://lwc.dev).
