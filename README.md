...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements) ⭐ 6,122 | 🐛 2,827 | 🌐 HTML | 📅 2026-08-25
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/shadow-dom) ⭐ 6,122 | 🐛 2,827 | 🌐 HTML | 📅 2026-08-25
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/html/semantics/scripting-1/the-template-element) ⭐ 6,122 | 🐛 2,827 | 🌐 HTML | 📅 2026-08-25
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/css/css-shadow-parts) ⭐ 6,122 | 🐛 2,827 | 🌐 HTML | 📅 2026-08-25
...
* [`<model-viewer>`](https://github.com/google/model-viewer) ⭐ 8,210 | 🐛 117 | 🌐 TypeScript | 📅 2026-07-07 - Web component for rendering interactive 3D models.
...
* [`<midi-player>`](https://github.com/cifkao/html-midi-player) ⭐ 901 | 🐛 21 | 🌐 TypeScript | 📅 2025-07-06 - MIDI file player and visualizer web components.
* [`<phantom-ui>`](https://github.com/Aejkatappaja/phantom-ui) ⭐ 790 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-31 - Skeleton loader that measures your real DOM to render matching shimmer placeholders.
...
* [`<progressive-image>`](https://github.com/andreruffert/progressive-image-element) ⭐ 270 | 🐛 2 | 🌐 HTML | 📅 2026-08-25 - Custom element to progressively enhance image placeholders.
...
* [`<web-vitals>`](https://github.com/stefanjudis/web-vitals-element) ⭐ 186 | 🐛 7 | 🌐 JavaScript | 📅 2023-08-15 - Bring [web vitals](https://github.com/GoogleChrome/web-vitals) ⭐ 8,593 | 🐛 12 | 🌐 JavaScript | 📅 2026-08-24 quickly into your page using custom elements.
* [`<notectl-editor>`](https://github.com/Samyssmile/notectl) ⭐ 182 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-16 - Modern rich text editor with plugin architecture, immutable state, and zero-config framework-agnostic deployment.
...
* [Wired Elements](https://github.com/wiredjs/wired-elements) ⭐ 10,829 | 🐛 36 | 🌐 TypeScript | 📅 2023-10-07 - Set of common UI elements with a hand-drawn, sketchy look.
...
* [Vaadin components](https://github.com/vaadin/web-components) ⭐ 581 | 🐛 925 | 🌐 JavaScript | 📅 2026-08-25 - Evolving set of high-quality web components for building business web applications.
* [Smart Web Components](https://github.com/HTMLElements/smart-webcomponents) ⭐ 482 | 🐛 17 | 🌐 CSS | 📅 2026-08-15 - Web components for business applications.
...
* [Wokwi Elements](https://github.com/wokwi/wokwi-elements) ⭐ 260 | 🐛 26 | 🌐 TypeScript | 📅 2026-08-06 - Web Components for Arduino and various electronic parts.
* [Clever components](https://github.com/CleverCloud/clever-components) ⭐ 240 | 🐛 328 | 🌐 JavaScript | 📅 2026-08-24 - Collection of Web Components made by Clever Cloud.
...
* [Ignite UI Web Components](https://github.com/IgniteUI/igniteui-webcomponents) ⭐ 169 | 🐛 38 | 🌐 TypeScript | 📅 2026-08-24 - Complete library of UI components from Infragistics.
...
* [PlayCanvas Web Components](https://github.com/playcanvas/web-components) ⭐ 107 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-25 - Custom elements for building 3D interactive web apps with the PlayCanvas Engine.
...
* [Brightspace UI core](https://github.com/BrightspaceUI/core) ⭐ 79 | 🐛 43 | 🌐 JavaScript | 📅 2026-08-24 - Collection of web components for building Brightspace applications.
...
* [Nuxeo Elements](https://github.com/nuxeo/nuxeo-elements) ⭐ 29 | 🐛 75 | 🌐 JavaScript | 📅 2026-08-25 - Components for building web applications with Nuxeo using Web Components.
...
* [TEI Publisher Components](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 60 | 🌐 JavaScript | 📅 2026-08-25 - Collection of web components used by TEI Publisher and apps generated by it.
...
* [Fusion Web Components](https://github.com/equinor/fusion-web-components) ⭐ 13 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-25 - Ser of web components used by Equinor Fusion.
...
* [Fluent UI Web Components](https://github.com/microsoft/fluentui/tree/master/packages/web-components) ⭐ 20,227 | 🐛 766 | 🌐 TypeScript | 📅 2026-08-25 - Library of Web Components that supports Microsoft's Fluent design language.
* [Material Web Components](https://github.com/material-components/material-web) ⭐ 11,197 | 🐛 179 | 🌐 SCSS | 📅 2026-08-21 - Material Design implemented as Web Components.
...
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,770 | 🐛 217 | 🌐 TypeScript | 📅 2026-08-25 - Set of reusable UI elements implementing SAP Fiori Design Guidelines.
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,530 | 🐛 234 | 🌐 TypeScript | 📅 2026-08-25 - Adobe Spectrum design language implementation built with Web Components.
...
* [PatternFly Elements](https://github.com/patternfly/patternfly-elements) ⭐ 393 | 🐛 170 | 🌐 TypeScript | 📅 2026-08-24 - Collection of flexible and lightweight Web Components based on the Unified Design Kit.
* [Calcite Components](https://github.com/Esri/calcite-components) ⭐ 373 | 🐛 992 | 🌐 TypeScript | 📅 2026-08-25 - Shared Web Components for Esri's Calcite design framework.
* [Siemens iX Web Components](https://github.com/siemens/ix/tree/main/packages/core) ⭐ 369 | 🐛 95 | 🌐 TypeScript | 📅 2026-08-25 - Web Components implementing Siemens iX design system.
...
* [Red Hat Design System](https://github.com/RedHat-UX/red-hat-design-system) ⭐ 148 | 🐛 197 | 🌐 HTML | 📅 2026-08-24 - Web components for building uniform experiences with the Red Hat brand.
* [OutlineJS](https://github.com/phase2/outline) ⭐ 131 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-11 - Web component based design system starter kit.
* [Pharos Design System](https://github.com/ithaka/pharos) ⭐ 131 | 🐛 72 | 🌐 TypeScript | 📅 2026-08-25 - JSTOR's design system to create cohesive, supportive, and beautiful experiences.
...
* [NVIDIA Elements](https://github.com/nvidia/elements) ⭐ 80 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-25 - The Design Language and UI Agent Harness for AI/ML Factories, Robotics, and Autonomous Vehicles.
* [Forge Components](https://github.com/tyler-technologies-oss/forge) ⭐ 68 | 🐛 62 | 🌐 TypeScript | 📅 2026-08-24 - Library of Web Components adhering to the Forge Design System.
...
* [Stencil](https://github.com/ionic-team/stencil) ⭐ 13,125 | 🐛 175 | 🌐 TypeScript | 📅 2026-08-24 - Compiler for generating Web Components.
...
* [Lightning Web Components](https://github.com/salesforce/lwc) ⭐ 1,786 | 🐛 413 | 🌐 JavaScript | 📅 2026-08-24 - blazing fast, enterprise-grade Web Components foundation.
...
* [Solid Element](https://github.com/solidjs/solid/tree/main/packages/solid-element) ⭐ 35,917 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-25 - Library that extends Solid adding Custom Web Components and extensions.
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/tree/master/custom-elements/form-associated) ⭐ 6,122 | 🐛 2,827 | 🌐 HTML | 📅 2026-08-25
...
* [web-platform-tests](https://github.com/web-platform-tests/wpt/blob/master/css/cssom/CSSStyleSheet-constructable.html) ⭐ 6,122 | 🐛 2,827 | 🌐 HTML | 📅 2026-08-25
...
* [@lwc/synthetic-shadow](https://github.com/salesforce/lwc/blob/master/packages/@lwc/synthetic-shadow) ⭐ 1,786 | 🐛 413 | 🌐 JavaScript | 📅 2026-08-24 - Shadow DOM polyfill by [LWC](https://lwc.dev).
